...
<!-- 그리드를 감싸는 div -->
  ...
  <div id="container-re" style="width:1599px;">

<c:forEach var="boardDtos" items="${boardDtos}" varStatus="status">


	<div id="post_1">
	  <div class="card border-light" id="card_1" onclick="location.href='/comso/jiseong/request.html';">
		...
		<div class="card-body">
		   <h3 class="card-title"><b>욕실 패키지1</b></h3>   
	...
	<div id="post_1">
	  <div class="card border-light" id="card_1" onclick="<%=request.getContextPath()%>/board/view?no=${boardDtos.no }';">
	    <img class="card-img-top" src="<%=request.getContextPath()%>/image/displayFile?fileName=${boardDtos.thumbnail }" id="index_r_image" alt="Card image cap">
		<div class="card-body">
